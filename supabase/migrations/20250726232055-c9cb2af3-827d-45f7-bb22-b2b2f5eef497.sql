-- تحديث مستويات الولاء حسب المطلوب
...
UPDATE public.loyalty_tiers 
SET points_required = 3000, free_delivery_threshold = 0
WHERE name = 'ماسي';

-- تحديث الذهبي ليشمل توصيل مجاني
UPDATE public.loyalty_tiers 
SET free_delivery_threshold = 0
WHERE name = 'ذهبي';

-- تحديث وظيفة حساب النقاط لتكون 19000 بدلاً من 20000
