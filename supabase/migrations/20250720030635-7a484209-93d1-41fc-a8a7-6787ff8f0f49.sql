-- إصلاح دالة تحديث المخزون لتعمل بدون مستخدم أيضاً
...
BEGIN
  ...
  -- الحصول على معرف المستخدم الحالي أو استخدام افتراضي
  current_user_id := auth.uid();
  IF current_user_id IS NULL THEN
    -- استخدام مستخدم افتراضي أو معرف ثابت
  ...
  ELSE
    ...
    SET cost_price = p_cost_price,
        price = GREATEST(price, p_cost_price * 1.2),
        updated_at = now()
