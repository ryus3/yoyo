...
DROP FUNCTION IF EXISTS public.get_inventory_stats(p_department_ids uuid[], p_category_ids uuid[], p_user_id uuid);

-- إعادة إنشاء الدالة الموحدة للمخزون مع اسم مختلف
